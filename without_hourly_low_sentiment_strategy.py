...
def init(context):
    ...
    # 读入情绪指数数据
    context.sentiment_index = pd.read_pickle('F://ricequant_internship//1211//sentiment_index_hourly_7am_1212.pkl')
...
def before_trading(context):
    ...
    if context.counter % context.period == 0:
        ...
        new_pool = recent_sentiment > recent_sentiment.quantile(0.2)
